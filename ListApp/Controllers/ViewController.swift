...
//  ListApp
//
//  Created by Alper Burak Öztürk on 1.04.2023.
//
...
class ViewController: UIViewController {
    ...
    @IBAction func removeBarButtonItemTapped(_ sender: Any) {
        presentAlert(title: "Uyarı?",
                     message: "Listedeki Bütün Elemanları Silmek İstediğine emin misin?",
    ...
    func presentAddAlert() {
        presentAlert(title: "Yeni Eleman Ekle",
            ...
            let text1 = self.alertController.textFields?.first?.text
            if text1 != "" {
                ...
                listItem.setValue(text1, forKey: "title")
...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "defaultCell", for: indexPath)// 1
